...
import static com.example.fb1.Data.userWon;

/**
 * A simple {@link Fragment} subclass.
 * Activities that contain this fragment must implement the
 * {@link OverFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link OverFragment#newInstance} factory method to
...
public class OverFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView tv = v.findViewById(R.id.gameOverResult);
        if (userWon) {
            tv.setText("YOU WON!!!");
        ...
        v.findViewById(R.id.home).setOnClickListener(new View.OnClickListener() {
            @Override
